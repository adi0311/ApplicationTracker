...
echo'<html>
		...
		<div class="ui stackable four column grid">
			...
			<div class="column">
				...
				<div class="ui vertical steps" style="display:block;">
					...
					<a href="/ApplicationTracker/acad_pend_fac.php"><div class="ui active step">
 ...
 if($result){
	 ...
	 while($info=mysqli_fetch_array($result)){
	 	echo '<tr class="clickable-row" data-href="/ApplicationTracker/acad_app_fac.php?faculty_id='.$info['faculty_id'].'&strdate='.$info['strdate'].'">
