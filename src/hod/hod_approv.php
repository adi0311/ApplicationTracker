...
$qry1 = "SELECT roll_no as ID,strdate,purpose,type,result from application_student where status='HOD' and result='Rejected' or status='HOD' and result='Accepted' UNION SELECT faculty_id as ID,strdate,purpose,type,result from application_faculty where status='HOD' and result='Rejected' or status='HOD' and result='Accepted'";
...
if($count2==1){
					...
					<a href="/ApplicationTracker/src/hod/hod_pend_fac.php"><div class="ui step">
						Pending Leave Faculty
					</div></a>
					<a href="/ApplicationTracker/src/hod/hod_approv.php"><div class="ui active step">
...
echo '</div>
			...
			<br>
			<table class="ui unstackable table"><thead><th>Id</th><th>Purpose</th><th>Type</th><th>Result</th></thead><tbody>';
 if($result1){
 	$init=0;
